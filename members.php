   ...
   ?>
    ...
    <div class="inner-banner">
        <section class="w3l-breadcrumb">
            <div class="container">
                <h4 class="inner-text-title font-weight-bold text-white mb-sm-3 mb-2">Member's form</h4>
                <ul class="breadcrumbs-custom-path">
                    <li><a href="index.php">Home</a></li>
                    <li class="active"><span class="fa fa-chevron-right mx-2" aria-hidden="true"></span>Members</li>
                </ul>
            </div>
        </section>
    </div>
    ...
    <div class="contact-form py-5">
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="section-heading text-center mb-sm-5 mb-4">
                        <h3 class="title-style mb-2">Member's Form</h3>
                        <p class="lead">
                            Already a heirs of salvation member? please fill out this form
                        </p>
                    </div>
                </div>
            </div>
        ...
        <?php } ?>
                <div class="contact-form mt-2">
                    <form action="proc_members.php" method="post" class="cont-form p-sm-5">
                        <div class="row">
                            <div class="col-md-6">
